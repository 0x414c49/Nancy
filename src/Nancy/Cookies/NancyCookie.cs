namespace Nancy.Cookies
{
    ...
    {
        /// <summary>
        /// Backing field for SameSite property, Wheather the cookie is same site
        /// </summary>
