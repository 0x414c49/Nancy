namespace Nancy.Tests.Unit
{
    ...
    public class NancyCookieFixture
    {
        ...
        [Fact]
        public void Should_add_same_site_if_set_to_none_and_set_cookie_secure()
        {
            // When
            var cookie = new NancyCookie("leto", "worm") { SameSite = SameSite.None }.ToString();

            // Then
            cookie.ShouldEqual("leto=worm; path=/; Secure; samesite=None");
        }
